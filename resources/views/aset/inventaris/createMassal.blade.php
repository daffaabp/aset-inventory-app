...
@section('content')
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Tambah Massal Aset Inventaris Ruangan</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Beranda</a></li>
                    <li class="breadcrumb-item active">Tambah Massal Aset Inventaris Ruangan </li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('inventaris.storeMassal') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    {{-- <label>Grup ID</label> --}}
                                    <input type="hidden" class="form-control" name="grup_id" value="{{ uniqid() }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        name="tanggal_inventarisir" value="{{ old('tanggal_inventarisir') }}" autofocus>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="jumlah" value="{{ old('jumlah') }}" autocomplete="off"
                                                    autofocus>
                                                @error('jumlah')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
