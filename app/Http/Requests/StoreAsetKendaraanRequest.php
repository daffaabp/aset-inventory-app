...
class StoreAsetKendaraanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'thn_pembelian' => 'required|numeric|digits:4|min:0|gte:thn_pembuatan',
    ...
    public function messages(): array
    {
        return [
            ...
            'thn_pembelian.gte' => 'Tahun Pembelian tidak boleh kurang dari Tahun Pembuatan',
            'no_polisi.required' => 'Nomor Polisi wajib diisi',
            'no_polisi.unique' => 'Nomor Polisi sudah ada di database (harus unik)',
